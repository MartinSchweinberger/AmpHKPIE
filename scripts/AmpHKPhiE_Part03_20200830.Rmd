...
ggplot(phi_very, aes(Gender, Probability)) +
  ...
  ggsave("D:\\Uni\\Projekte\\02-Intensification\\AmpHKPIE\\images/Pred_Gender_phi_very.png",
       height = 5,  width = 6, dpi = 320)
```
...
ggplot(phi_very, aes(Adjective, Probability)) +
  ...
  ggsave("D:\\Uni\\Projekte\\02-Intensification\\AmpHKPIE\\images/Pred_Adjective_phi_very.png",
       height = 5,  width = 6, dpi = 320)
```
...
ggplot(rndmlngtb, aes(Speaker, Intercept)) +
  ...
  ggsave("D:\\Uni\\Projekte\\02-Intensification\\AmpHKPIE\\images/Pred_Speaker_phi_very.png",
...
ggplot(phi_really, aes(SemanticCategory, Probability)) +
  ...
  theme(legend.position="top",
        ...
        axis.text.x = element_text(size=10, angle = 90)) +
  labs(x = "SemanticCategory", y = "Predicted probability") +
  ggsave("D:\\Uni\\Projekte\\02-Intensification\\AmpHKPIE\\images/Pred_SemanticCategory_phi_really.png",
       height = 5,  width = 6, dpi = 320)
```
...
ggplot(rndmlngtb, aes(Speaker, Intercept)) +
  ...
  ggsave("D:\\Uni\\Projekte\\02-Intensification\\AmpHKPIE\\images/Pred_Speaker_phi_really.png",
       height = 4,  width = 5, dpi = 320)
```
...
ggplot(phi_so, aes(Age, Probability)) +
  ...
  ggsave("D:\\Uni\\Projekte\\02-Intensification\\AmpHKPIE\\images/Pred_Age_phi_so.png",
       height = 5,  width = 6, dpi = 320)
```
...
ggplot(phi_so, aes(Priming, Probability)) +
  ...
  ggsave("D:\\Uni\\Projekte\\02-Intensification\\AmpHKPIE\\images/Pred_Priming_phi_so.png",
       height = 5,  width = 6, dpi = 320)
```
...
ggplot(rndmlngtb, aes(Speaker, Intercept)) +
  ...
  theme(legend.position="none",
        ...
        axis.text.x = element_text(size=5, angle=90)) +
  labs(x = "Speaker", y = "Adjustment to Intercept") +
  ggsave("D:\\Uni\\Projekte\\02-Intensification\\AmpHKPIE\\images/Pred_Speaker_phi_so.png",
       height = 4,  width = 5, dpi = 320)
```
...
combined %>%
  ...
  ggsave("D:\\Uni\\Projekte\\02-Intensification\\AmpHKPIE\\images/Pred_Age_phi_Variants.png",
       height = 5,  width = 6, dpi = 320)
```
